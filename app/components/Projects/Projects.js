...
const PROJECTS = [
  {
    ...
    description: 'Create a clean, professional resume instantly. Perfect for students, job seekers, and professionals who want a modern resume without spending hours formatting.',
    ...
    features: ['Professional resume templates', 'Easy-to-use interface', 'Real-time preview', 'Multiple export formats', 'Customizable sections'],
  },
  {
    id: 'job-tracker',
    title: 'Job Application Tracker',
    description: 'A simple, offline-first Job Application Tracker to organize your job hunt in one clean dashboard. Track applications, interviews, and follow-ups.',
    tags: ['JavaScript', 'HTML', 'CSS', 'LocalStorage'],
    gradient: 'linear-gradient(135deg, #06b6d4 0%, #3b82f6 100%)',
    icon: '💼',
    github: 'https://github.com/Dantescenario/job-application-tracker',
    live: 'https://glittery-centaur-192dca.netlify.app/',
    videoUrl: 'https://res.cloudinary.com/dpcnteaog/video/upload/v1768469405/job-tracker_qmlbaj.mp4',
    features: ['Track job applications', 'Manage interview schedules', 'Offline-first functionality', 'Application status updates', 'Clean dashboard'],
  },
  {
    id: 'finance-dashboard',
    title: 'Finance Dashboard',
    description: 'A comprehensive finance dashboard for data visualization using interactive charts and analytics. Visualize your financial data in real-time.',
    tags: ['Python', 'Data Visualization', 'Charts'],
    ...
    features: ['Interactive charts and graphs', 'Financial data visualization', 'Real-time analytics', 'Expense tracking', 'Budget management'],
  },
  {
    id: 'goal-tracker',
    title: 'Goal Tracker Pro',
    description: 'A modern, feature-rich goal tracking application built with React, Vite, and Tailwind CSS. Track daily, weekly, and monthly goals.',
    ...
    features: ['Daily, weekly, monthly goals', 'Progress tracking', 'Real-time updates', 'Beautiful UI', 'Goal analytics'],
  },
];
